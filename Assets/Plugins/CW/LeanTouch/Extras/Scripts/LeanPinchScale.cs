...
namespace Lean.Touch
{
    ...
    {
        [SerializeField] private float minZoom;   // Minimum object scale
        ...
        protected virtual void Update()
        {
            ...
            if (pinchScale != 1.0f)
            {
                ...
                // Clamp the scale to the specified limits
                transform.localScale = Vector3.Max(Vector3.Min(transform.localScale, new Vector3(maxZoom, maxZoom, maxZoom)), new Vector3(minZoom, minZoom, minZoom));
            }
            // Store
